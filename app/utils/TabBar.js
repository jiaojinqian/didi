            ...
            <View style={[styles.tabs, this.props.style]}>
                {this.props.tabs.map((tab, i) => {
                    ...
                    return <TouchableOpacity activeOpacity={1} key={tab.iconName} onPress={() => this.props.goToPage(i)} style={styles.tab}>
                        <Image style={{width: 30, height: 27}} source={this.props.activeTab == i ? Icons.tabBars[tab.iconName+'Hover'] : Icons.tabBars[tab.iconName]}></Image>
                        <Text style={{fontSize:12,color:colori}}>{tab.name}</Text>
                    </TouchableOpacity>;
                })}
            </View>
